"""This module models a deposit-collateral instruction."""
...
from sdk.constants import QUOTE_PRECISION, Number


class DepositCollateralInstruction(InstructionCore):
    """Object to model a deposit-collateral instruction."""
    layout = Struct(
