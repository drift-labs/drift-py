...
class InitializeInstruction(InstructionCore):
    ...
    def __init__(self, clearing_house_nonce: int, collateral_vault_nonce: int, insurance_vault_nonce: int,
                 admin_controls_prices: int) -> None:
    ...
    def get_instruction(self, admin: PublicKey, state: PublicKey, collateral_mint: PublicKey,
                        collateral_vault: PublicKey, collateral_vault_authority: PublicKey,
                        insurance_vault: PublicKey, insurance_vault_authority: PublicKey, markets: PublicKey,
                        rent: PublicKey, system_program: PublicKey, token_program: PublicKey,
